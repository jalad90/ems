...
public class UserLeaveDetailDto {
	...
	private RegisterUserDTO objRegisterDto;

	public RegisterUserDTO getObjRegisterDto() {
		return objRegisterDto;
	}

	public void setObjRegisterDto(RegisterUserDTO objRegisterDto) {
		this.objRegisterDto = objRegisterDto;
	}
